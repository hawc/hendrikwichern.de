...
export function Link({ children, href, arrow = false, className }: PropsWithChildren<LinkProps>) {
  return (
    <NextLink target={href.includes('http') ? '_blank' : '_self'} className={`font-bold ${className}`} href={href}>
