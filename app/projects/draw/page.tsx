      ...
      <main className='grid gap-2px'>
        ...
        <Container>
          <Box>
            ...
            <p>The renderers linked below use various libraries for client side rendering, e.g. Three.js, p5.js or simple SVG + CSS.</p>
            ...
            <p>As most of the 3D rendering logic is not performance optimized, this is considered desktop only right now.</p>
          </Box>
        </Container>
